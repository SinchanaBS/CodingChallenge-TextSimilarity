...
$ python app.py 
(make sure to be in web folder to run above cmd, you can use cd to navigate to web folder)
Now you can check on your link shown on the terminal you run your program (localhost:5000)

Running the program with Docker:
Make sure to have the docker installed and Virtual Machine with the network port http and connected to the internet.
...
Bonus: Have tried creating a Web service API with the POST method. Flask library was helpful. Utilized the docker Container to add the Web Service and run it. Finally uploaded to the GitHub.
